...
const WHATSAPP_NOT_CONFIGURED = {
  ...
  webhook_status: "waiting", webhook_url: "https://example.test/api/integrations/whatsapp/webhook",
...
const WHATSAPP_CONNECTED = {
  ...
  webhook_status: "connected", webhook_url: "https://example.test/api/integrations/whatsapp/webhook",
